...
\title{LING 574 HW4}
\date{\vspace{-0.2in}Due 11:59PM on May 1, 2025}
\maketitle
...
\begin{align*}
  ...
  \\
  \text{where } G_{t, i} &= \sum_{k=0}^t g_{k, i}^2
  \\
