...
\title{LING 574 HW5}
\date{\vspace{-0.2in}Due 11:59PM on May 8, 2025}
\maketitle
...
\end{itemize}
All files referenced herein may be found in \texttt{/mnt/dropbox/24-25/574/hw5/} on patas.
...
\texttt{run.py} contains a basic training loop for a feed-forward language model, which will record the training loss and generate text every $N$ epochs (controlled by the flag \texttt{--generate\_every}, set to 4 by default).
