...
\begin{itemize}
  ...
  \item Using the chain rule, compute $\frac{d}{dx}\left(-\log\sigma(x)\right)$.  [Hint: first, show that $\sigma(x) = \frac{e^x}{e^x+1}$.  Note: $\log$ here is the natural logarithm, i.e. logarithm with base $e$.] [4 pts]
